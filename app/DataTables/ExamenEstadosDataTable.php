...
class ExamenEstadosDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
       ...
       return $dataTable->addColumn('action', function(ExamenEstados $examenEstados){
             ...
             ->editColumn('id',function (ExamenEstados $examenEstados){
                 ...
                 //return view('examen_estados.modal_detalles',compact('examenEstados'))->render();
    ...
    {
        return 'examen_estadosdatatable_' . time();
    }
}
